...
{
    public class PaymentDataProfile : Profile
    {
        public PaymentDataProfile()
        {
            CreateMap<PaymentDataRequest, PaymentDataCommand>();
            CreateMap<PaymentData, PaymentDataResponse>();
        }
    }
}
